...
//    
    ...
    private void adduser(ActionEvent event) throws IOException, Exception{
        ...
        if(result.get() == ButtonType.OK){
         String username = txt_nom.getText();
...
//             Alert alert = new Alert(Alert.AlertType.ERROR);
             ...
             Users e=new Users(1,cin,tel,username,prenom,email,password,rpassword ,typeuser);
...
//        notificationBuilder.show();
    ...
    private void updateUser(ActionEvent event) {
        ...
        try{
             ...
             String sql = "update users set id = '"+value1+"', cin = '"+value2+"', username='"+value3+"',prenom='"+value4+"',tel='"+value5+"',email='"+value6+"',password='"+value7+"',repeatPassword='"+value8+"',typeUser='"+value9+"' where id ='"+value1+"'";
             ste=mc.prepareStatement(sql);
             ste.execute();
    ...
    private void getSelected(MouseEvent event) {
        ...
        txt_nom.setText(String.valueOf(clickedUser.getUsername()));
